...
class StandardRPNHead(nn.Module):
    ...
    def forward(self, features: List[torch.Tensor]):
        ...
        for x in features:
            t = self.conv(x)
            #total_flops += FlopCountAnalysis(self.conv, x).total()
            #total_flops += FlopCountAnalysis(self.objectness_logits, t).total()
            #total_flops += FlopCountAnalysis(self.anchor_deltas, t).total()
